...
if (typeof usi_app === 'undefined' && location.href.indexOf("http") === 0) {
	try {
		if("undefined"==typeof usi_cookies){if(usi_cookies={expire_time:{minute:60,hour:3600,two_hours:7200,four_hours:14400,day:86400,week:604800,two_weeks:1209600,month:2592e3,year:31536e3,never:31536e4},max_cookies_count:15,max_cookie_length:1e3,update_window_name:function(e,o,i){try{var s=-1;if(-1!=i){var n=new Date;n.setTime(n.getTime()+1e3*i),s=n.getTime()}var t=window.top||window,r=0;null!=o&&-1!=o.indexOf("=")&&(o=o.replace(new RegExp("=","g"),"USIEQLS")),null!=o&&-1!=o.indexOf(";")&&(o=o.replace(new RegExp(";","g"),"USIPRNS"));for(var c=t.name.split(";"),_="",u=0;u<c.length;u++){var a=c[u].split("=");3==a.length?(a[0]==e&&(a[1]=o,a[2]=s,r=1),null!=a[1]&&"null"!=a[1]&&(_+=a[0]+"="+a[1]+"="+a[2]+";")):""!=c[u]&&(_+=c[u]+";")}0==r&&(_+=e+"="+o+"="+s+";"),t.name=_}catch(e){}},flush_window_name:function(e){try{for(var o=window.top||window,i=o.name.split(";"),s="",n=0;n<i.length;n++){var t=i[n].split("=");3==t.length&&(0==t[0].indexOf(e)||(s+=i[n]+";"))}o.name=s}catch(e){}},get_from_window_name:function(e){try{for(var o,i=(window.top||window).name.split(";"),s=0;s<i.length;s++){var n=i[s].split("=");if(3==n.length){if(n[0]==e&&(-1!=(o=n[1]).indexOf("USIEQLS")&&(o=o.replace(new RegExp("USIEQLS","g"),"=")),-1!=o.indexOf("USIPRNS")&&(o=o.replace(new RegExp("USIPRNS","g"),";")),!("-1"!=n[2]&&usi_cookies.datediff(n[2])<0)))return[o,n[2]]}else if(2==n.length&&n[0]==e)return-1!=(o=n[1]).indexOf("USIEQLS")&&(o=o.replace(new RegExp("USIEQLS","g"),"=")),-1!=o.indexOf("USIPRNS")&&(o=o.replace(new RegExp("USIPRNS","g"),";")),[o,(new Date).getTime()+6048e5]}}catch(e){}return null},datediff:function(e){return e-(new Date).getTime()},count_cookies:function(e){return e=e||"usi_",usi_cookies.search_cookies(e).length},root_domain:function(){try{var e=document.domain.split("."),o=e[e.length-1];if("com"==o||"net"==o||"org"==o||"us"==o||"co"==o||"ca"==o)return e[e.length-2]+"."+e[e.length-1]}catch(e){}return 0==document.domain.indexOf("www.")?document.domain.replace("www.",""):document.domain},create_cookie:function(e,o,i){if(!1!==navigator.cookieEnabled&&void 0===window.usi_nocookies){var s="";if(-1!=i){var n=new Date;n.setTime(n.getTime()+1e3*i),s="; expires="+n.toGMTString()}var t="samesite=none;";0==location.href.indexOf("https://")&&(t+="secure;");var r=usi_cookies.root_domain();"undefined"!=typeof usi_parent_domain&&-1!=document.domain.indexOf(usi_parent_domain)&&(r=usi_parent_domain),document.cookie=e+"="+encodeURIComponent(o)+s+"; path=/;domain="+r+"; "+t}},create_nonencoded_cookie:function(e,o,i){if(!1!==navigator.cookieEnabled&&void 0===window.usi_nocookies){var s="";if(-1!=i){var n=new Date;n.setTime(n.getTime()+1e3*i),s="; expires="+n.toGMTString()}var t="samesite=none;";0==location.href.indexOf("https://")&&(t+="secure;");var r=usi_cookies.root_domain();document.cookie=e+"="+o+s+"; path=/;domain="+location.host+"; "+t,document.cookie=e+"="+o+s+"; path=/;domain="+r+"; "+t,document.cookie=e+"="+o+s+"; path=/;domain=; "+t}},read_cookie:function(e){if(!1===navigator.cookieEnabled)return null;var o=e+"=",i=[];try{i=document.cookie.split(";")}catch(e){}for(var s=0;s<i.length;s++){for(var n=i[s];" "==n.charAt(0);)n=n.substring(1,n.length);if(0==n.indexOf(o))return decodeURIComponent(n.substring(o.length,n.length))}return null},del:function(e){usi_cookies.set(e,null,-100);try{null!=localStorage&&localStorage.removeItem(e),null!=sessionStorage&&sessionStorage.removeItem(e)}catch(e){}},get_ls:function(e){try{var o=localStorage.getItem(e);if(null!=o){if(0==o.indexOf("{")&&-1!=o.indexOf("usi_expires")){var i=JSON.parse(o);if((new Date).getTime()>i.usi_expires)return localStorage.removeItem(e),null;o=i.value}return decodeURIComponent(o)}}catch(e){}return null},get:function(e){var o=usi_cookies.read_cookie(e);if(null!=o)return o;try{if(null!=localStorage&&null!=(o=usi_cookies.get_ls(e)))return o;if(null!=sessionStorage&&(void 0===(o=sessionStorage.getItem(e))&&(o=null),null!=o))return decodeURIComponent(o)}catch(e){}var i=usi_cookies.get_from_window_name(e);if(null!=i&&i.length>1)try{o=decodeURIComponent(i[0])}catch(e){return i[0]}return o},get_json:function(e){var o=null,i=usi_cookies.get(e);if(null==i)return null;try{o=JSON.parse(i)}catch(e){i=i.replace(/\\"/g,'"');try{o=JSON.parse(JSON.parse(i))}catch(e){try{o=JSON.parse(i)}catch(e){}}}return o},search_cookies:function(e){e=e||"";var o=[];return document.cookie.split(";").forEach(function(i){var s=i.split("=")[0].trim();""!==e&&0!==s.indexOf(e)||o.push(s)}),o},set:function(e,o,i,s){"undefined"!=typeof usi_nevercookie&&1==usi_nevercookie&&(s=!1),void 0===i&&(i=-1);try{o=o.replace(/(\r\n|\n|\r)/gm,"")}catch(e){}"undefined"==typeof usi_windownameless&&usi_cookies.update_window_name(e+"",o+"",i);try{if(i>0&&null!=localStorage){var n={value:o,usi_expires:(new Date).getTime()+1e3*i};localStorage.setItem(e,JSON.stringify(n))}else null!=sessionStorage&&sessionStorage.setItem(e,o)}catch(e){}if(s||null==o){if(null!=o){if(null==usi_cookies.read_cookie(e))if(!s)if(usi_cookies.search_cookies("usi_").length+1>usi_cookies.max_cookies_count)return void usi_cookies.report_error('Set cookie "'+e+'" failed. Max cookies count is '+usi_cookies.max_cookies_count);if(o.length>usi_cookies.max_cookie_length)return void usi_cookies.report_error('Cookie "'+e+'" truncated ('+o.length+"). Max single-cookie length is "+usi_cookies.max_cookie_length)}usi_cookies.create_cookie(e,o,i)}},set_json:function(e,o,i,s){var n=JSON.stringify(o).replace(/^"/,"").replace(/"$/,"");usi_cookies.set(e,n,i,s)},flush:function(e){e=e||"usi_";var o,i,s,n=document.cookie.split(";");for(o=0;o<n.length;o++)0==(i=n[o]).trim().toLowerCase().indexOf(e)&&(s=i.trim().split("=")[0],usi_cookies.del(s));usi_cookies.flush_window_name(e);try{if(null!=localStorage)for(var t in localStorage)0==t.indexOf(e)&&localStorage.removeItem(t);if(null!=sessionStorage)for(var t in sessionStorage)0==t.indexOf(e)&&sessionStorage.removeItem(t)}catch(e){}},print:function(){for(var e=document.cookie.split(";"),o="",i=0;i<e.length;i++){var s=e[i];0==s.trim().toLowerCase().indexOf("usi_")&&(console.log(decodeURIComponent(s.trim())+" (cookie)"),o+=","+s.trim().toLowerCase().split("=")[0]+",")}try{if(null!=localStorage)for(var n in localStorage)0==n.indexOf("usi_")&&"string"==typeof localStorage[n]&&-1==o.indexOf(","+n+",")&&(console.log(n+"="+usi_cookies.get_ls(n)+" (localStorage)"),o+=","+n+",");if(null!=sessionStorage)for(var n in sessionStorage)0==n.indexOf("usi_")&&"string"==typeof sessionStorage[n]&&-1==o.indexOf(","+n+",")&&(console.log(n+"="+sessionStorage[n]+" (sessionStorage)"),o+=","+n+",")}catch(e){}for(var t=(window.top||window).name.split(";"),r=0;r<t.length;r++){var c=t[r].split("=");if(3==c.length&&0==c[0].indexOf("usi_")&&-1==o.indexOf(","+c[0]+",")){var _=c[1];-1!=_.indexOf("USIEQLS")&&(_=_.replace(new RegExp("USIEQLS","g"),"=")),-1!=_.indexOf("USIPRNS")&&(_=_.replace(new RegExp("USIPRNS","g"),";")),console.log(c[0]+"="+_+" (window.name)"),o+=","+s.trim().toLowerCase().split("=")[0]+","}}},value_exists:function(){var e,o;for(e=0;e<arguments.length;e++)if(""===(o=usi_cookies.get(arguments[e]))||null===o||"null"===o||"undefined"===o)return!1;return!0},report_error:function(e){"undefined"!=typeof usi_commons&&"function"==typeof usi_commons.report_error&&usi_commons.report_error(e)},check_multi_domain:function(){try{"undefined"!=typeof usi_app&&usi_app.company_id?usi_cookies.get("usi_app.company_id")?usi_cookies.get("usi_app.company_id")!==usi_app.company_id&&(window.name=""):usi_cookies.set("usi_app.company_id",usi_app.company_id):setTimeout(function(){usi_cookies.check_multi_domain()},2e3)}catch(e){"undefined"!=typeof usi_commons&&usi_commons.report_error(e)}},monitor_page_views:function(){try{if(void 0===usi_cookies.last_url||usi_cookies.last_url!=location.href){usi_cookies.last_url=location.href;var e=window.self===window.top,o=-1!==location.href.indexOf("/checkouts/");e&&(usi_cookies.get("usi_entry_url_1")||usi_cookies.set("usi_entry_url_1",usi_cookies.last_url,21600),null==document.referrer||usi_cookies.get("usi_referrer_url")||-1!=document.referrer.indexOf(location.host)||usi_cookies.set("usi_referrer_url",document.referrer||"direct traffic",21600)),(e||o)&&(usi_cookies.get("usi_entry_url_1")&&usi_cookies.get("usi_entry_url_1")!=usi_cookies.last_url&&usi_cookies.set("usi_last_url_1",usi_cookies.last_url,21600),usi_cookies.set("usi_pv_count",String(Number(usi_cookies.get("usi_pv_count")||0)+1),21600))}setTimeout(usi_cookies.monitor_page_views,2e3)}catch(e){"undefined"!=typeof usi_commons&&usi_commons.report_error(e)}}},"undefined"!=typeof usi_commons&&"function"==typeof usi_commons.gup&&"function"==typeof usi_commons.gup_or_get_cookie)try{usi_commons.force_date=usi_commons.gup_or_get_cookie("usi_force_date"),usi_commons.force_group=usi_commons.gup_or_get_cookie("usi_force_group"),usi_commons.is_enabled=""!=usi_commons.gup_or_get_cookie("usi_enable",usi_cookies.expire_time.hour,!0),usi_commons.is_forced=""!=usi_commons.gup_or_get_cookie("usi_force",usi_cookies.expire_time.hour,!0),""!=usi_commons.gup("usi_email_id")?usi_cookies.set("usi_email_id",usi_commons.gup("usi_email_id").split(".")[0],Number(usi_commons.gup("usi_email_id").split(".")[1]),!0):null==usi_cookies.read_cookie("usi_email_id")&&null!=usi_cookies.get_from_window_name("usi_email_id")&&usi_cookies.set("usi_email_id",usi_cookies.get_from_window_name("usi_email_id")[0],(usi_cookies.get_from_window_name("usi_email_id")[1]-(new Date).getTime())/1e3,!0),""!=usi_commons.gup_or_get_cookie("usi_debug")&&(usi_commons.debug=!0),""!=usi_commons.gup_or_get_cookie("usi_qa")&&(usi_commons.domain=usi_commons.cdn="https://prod.upsellit.com"),usi_cookies.monitor_page_views()}catch(e){usi_commons.report_error(e)}-1!=location.href.indexOf("usi_clearcookies")&&usi_cookies.flush(),usi_commons.objects=["product_rec","product","product_recs","abandon_recs","base_products","buypage_addons","campaign_56959","cart_items","cart_recs","cart_upsell_recs","cross_sell_products","discontinued_rec","filter_rec0","inpage_data","minicart_rec","minicart_recs","newproducts_data","oos_data","oos_rec","oos_rec_data","pdpbundler_recs","prod_27450","product_rec_cart","product_rec_minicart","product_rec_oos","rec_48323","rec_58915","rec_58917","rec_58921","rec_cart_items","recs","recs_34089","recs_51731","search_rec","toppicks","toppicks_customizations","topproducts_data","trade_up_products","variant_group_0","variant_group_1","variant_group_2","variant_group_3","variant_group_4","variant_group_5","variant_group_6","variant_group_7","variant_group_8","variant_group_9"],setTimeout(function(){try{if("undefined"!=typeof usi_app&&null!=usi_cookies.get("usi_back_clicked")&&window.self===window.top){void 0!==usi_app.common_objects&&(usi_commons.objects=usi_commons.objects.concat(usi_app.common_objects)),usi_cookies.get("usi_record_rec_names")&&(usi_commons.objects=usi_commons.objects.concat(usi_cookies.get("usi_record_rec_names").split(",")));for(var e=0;e<usi_commons.objects.length;e++)null!=usi_cookies.get("usi_app_"+usi_commons.objects[e])&&(usi_app[usi_commons.objects[e]]=JSON.parse(usi_cookies.get("usi_app_"+usi_commons.objects[e])),usi_cookies.del("usi_app_"+usi_commons.objects[e]));if(usi_cookies.get("usi_back_clicked")){var o=usi_cookies.get("usi_back_clicked").split("_");3===o.length&&usi_commons.load_view(o[0],o[1],"configID:"+o[2],function(){usi_js.cleanup=function(){}})}}}catch(e){usi_commons.report_error(e)}},10)}
...
if (typeof usi_company_json === 'undefined') {try {usi_company_json = {
  ...
  "message_20off_video": {
    "english": {
      ...
      "header1_p2": "",
      "header2_p2": "Your 20% discount will be applied at checkout.",
      "cta": "Redeem Now",
      "your_cart": "Your Cart",
      "subtotal": "Subtotal",
      "discount": "Discount",
      ...
      "header2_p2_test": "Click the code below to copy and apply at checkout"
    },
    "sichinese": {
      "header1": "\u9650\u65F6\u4F18\u60E0",
      "header2": "\u4ECA\u65E5\u8BA2\u8D2D\u89C6\u9891\u7D20\u6750\uFF0C\u7ACB\u4EAB\u6298\u4F18\u60E0",
      "header1_p2": "",
      "header2_p2": "\u60A8\u768420%\u6298\u6263\u5C06\u5728\u7ED3\u8D26\u65F6\u81EA\u52A8\u5E94\u7528\u3002",
      "cta": "\u7ACB\u5373\u5151\u6362",
      "your_cart": "\u60A8\u7684\u5361\u53F7",
      "subtotal": "\u5C0F\u8BA1",
      "discount": "\u6298\u6263",
      ...
      "header2_p2_test": "\u70B9\u51FB\u4E0B\u65B9\u4F18\u60E0\u7801\u5373\u53EF\u590D\u5236\uFF0C\u7ED3\u8D26\u65F6\u76F4\u63A5\u4F7F\u7528"
    },
    "trchinese": {
      "header1": "\u9650\u6642\u512A\u60E0",
      "header2": "\u4ECA\u65E5\u8A02\u8CFC\u5F71\u7247\u7D20\u6750\uFF0C\u7ACB\u4EAB\u516B\u6298\u512A\u60E0",
      "header1_p2": "",
      "header2_p2": "\u60A8\u768420%\u6298\u6263\u5C07\u5728\u7D50\u5E33\u6642\u81EA\u52D5\u5957\u7528\u3002",
      "cta": "\u5FEB\u6765\u5151\u6362\u5427",
      "your_cart": "\u60A8\u7684\u5361\u865F",
      "subtotal": "\u5C0F\u8A08",
      "discount": "\u6298\u6263",
      ...
      "header2_p2_test": "\u9EDE\u64CA\u4E0B\u65B9\u4EE3\u78BC\u4EE5\u8907\u88FD\uFF0C\u4E26\u65BC\u7D50\u5E33\u6642\u4F7F\u7528"
    },
    "czech": {
      "header1": "\u010Casov\u011B omezen\u00E1 nab\u00EDdka",
      "header2": "Z\u00EDskejte slevu 20% na va\u0161i objedn\u00E1vku videa",
      "header1_p2": "",
      "header2_p2": "Va\u0161e 20% sleva bude uplatn\u011Bna p\u0159i finalizaci objedn\u00E1vky.",
      "cta": "Uplatnit nyn\u00ED",
      "your_cart": "V\u00E1\u0161 ko\u0161\u00EDk",
      "subtotal": "Mezisou\u010Det",
      "discount": "Sleva",
      ...
      "header2_p2_test": "Kliknut\u00EDm na n\u00ED\u017Ee uveden\u00FD k\u00F3d jej zkop\u00EDrujte a uplatn\u011Bte p\u0159i placen\u00ED"
    },
    "danish": {
      "header1": "Kun i en begr\u00E6nset periode",
      "header2": "20% p\u00E5 din bestilling af videooptagelser i dag",
      "header1_p2": "",
      "header2_p2": "Din 20% rabat fratr\u00E6kkes automatisk i kassen.",
      "cta": "Indl\u00F8s nu",
      "your_cart": "Din kurv",
      "subtotal": "Subtotal",
      "discount": "Rabat",
      ...
      "header2_p2_test": "Klik p\u00E5 koden nedenfor for at kopiere og bruge den ved betaling"
    },
    "finland": {
      "header1": "Voimassa vain rajoitetun ajan",
      "header2": "T\u00E4n\u00E4\u00E4n 20 % alennusta videomateriaaleista",
      "header1_p2": "",
      "header2_p2": "20% alennus my\u00F6nnet\u00E4\u00E4n kassalla.",
      "cta": "Lunasta nyt",
      ...
      "header2_p2_test": "Kopioi alla oleva koodi klikkaamalla sit\u00E4 ja k\u00E4yt\u00E4 kassalla"
    },
    "hungary": {
      "header1": "Csak korl\u00E1tozott ideig",
      "header2": "20% kedvezm\u00E9ny a f\u00E1jlod m\u00E9ret\u00E9re ma",
      "header1_p2": "",
      "header2_p2": "A 20% kedvezm\u00E9nyt fizet\u00E9skor haszn\u00E1lhatod fel.",
      "cta": "Bev\u00E1lt\u00E1s most",
      "your_cart": "A kosara",
      "subtotal": "V\u00E9g\u00F6sszeg",
      "discount": "Engedm\u00E9ny",
      ...
      "header2_p2_test": "Kattints az al\u00E1bbi k\u00F3dra a m\u00E1sol\u00E1shoz \u00E9s a k\u00F3d fizet\u00E9skor t\u00F6rt\u00E9n\u0151 felhaszn\u00E1l\u00E1s\u00E1hoz"
    },
    "norway": {
      "header1": "Tidsbegrenset tilbud",
      "header2": "20% rabatt p\u00E5 ditt kj\u00F8p av videoopptak i dag",
      "header1_p2": "",
      "header2_p2": "Rabatten p\u00E5 20% aktiveres i kassen.",
      "cta": "L\u00F8s inn n\u00E5",
      ...
      "header2_p2_test": "Klikk p\u00E5 koden nedenfor for \u00E5 kopiere og bruke den i kassa"
    },
    "polish": {
      "header1": "Oferta ograniczona czasowo",
      "header2": "Zni\u017Cka 20% na dzisiaj kupione filmy",
      "header1_p2": "",
      "header2_p2": "Zni\u017Cka 20% zostanie naliczona podczas realizacji zam\u00F3wienia.",
      ...
      "header2_p2_test": "Kliknij poni\u017Cszy kod, aby go skopiowa\u0107 i u\u017Cy\u0107 podczas realizacji zam\u00F3wienia"
    },
    "russia": {
      "header1": "\u041F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u043E\u0433\u0440\u0430\u043D\u0438\u0447\u0435\u043D\u043E \u043F\u043E \u0432\u0440\u0435\u043C\u0435\u043D\u0438",
      "header2": "\u0421\u043A\u0438\u0434\u043A\u0430 20% \u043D\u0430 \u0437\u0430\u043A\u0430\u0437 \u0432\u0438\u0434\u0435\u043E\u043C\u0430\u0442\u0435\u0440\u0438\u0430\u043B\u043E\u0432 \u0441\u0435\u0433\u043E\u0434\u043D\u044F",
      "header1_p2": "",
      "header2_p2": "\u0421\u043A\u0438\u0434\u043A\u0430 20% \u0431\u0443\u0434\u0435\u0442 \u043F\u0440\u0438\u043C\u0435\u043D\u0435\u043D\u0430 \u043F\u0440\u0438 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u0438 \u0437\u0430\u043A\u0430\u0437\u0430.",
      "cta": "\u0410\u043A\u0442\u0438\u0432\u0438\u0440\u043E\u0432\u0430\u0442\u044C",
      ...
      "header2_p2_test": "\u041D\u0430\u0436\u043C\u0438\u0442\u0435 \u043D\u0430 \u043A\u043E\u0434 \u043D\u0438\u0436\u0435, \u0447\u0442\u043E\u0431\u044B \u0441\u043A\u043E\u043F\u0438\u0440\u043E\u0432\u0430\u0442\u044C \u0435\u0433\u043E \u0438 \u043F\u0440\u0438\u043C\u0435\u043D\u0438\u0442\u044C \u043F\u0440\u0438 \u043E\u0444\u043E\u0440\u043C\u043B\u0435\u043D\u0438\u0438 \u0437\u0430\u043A\u0430\u0437\u0430."
    },
    "sweden": {
      "header1": "Endast under en begr\u00E4nsad tid",
      "header2": "20 % rabatt p\u00E5 din best\u00E4llning av filmmaterial idag",
      "header1_p2": "",
      "header2_p2": "Din rabatt p\u00E5 20 % dras av vid kassan.",
      "cta": "L\u00F6s in nu",
      ...
      "header2_p2_test": "Klicka p\u00E5 koden nedan f\u00F6r att kopiera den och anv\u00E4nda den i kassan"
    },
    "thai": {
      "header1": "\u0E14\u0E48\u0E27\u0E19! \u0E40\u0E27\u0E25\u0E32\u0E08\u0E33\u0E01\u0E31\u0E14",
      "header2": "\u0E23\u0E31\u0E1A\u0E2A\u0E48\u0E27\u0E19\u0E25\u0E14 20% \u0E2A\u0E33\u0E2B\u0E23\u0E31\u0E1A\u0E01\u0E32\u0E23\u0E2A\u0E31\u0E48\u0E07\u0E0B\u0E37\u0E49\u0E2D\u0E04\u0E25\u0E34\u0E1B\u0E27\u0E34\u0E14\u0E35\u0E42\u0E2D\u0E27\u0E31\u0E19\u0E19\u0E35\u0E49",
      "header1_p2": "",
      "header2_p2": "\u0E2A\u0E48\u0E27\u0E19\u0E25\u0E14 20% \u0E08\u0E30\u0E16\u0E39\u0E01\u0E43\u0E0A\u0E49\u0E43\u0E19\u0E02\u0E31\u0E49\u0E19\u0E15\u0E2D\u0E19\u0E01\u0E32\u0E23\u0E0A\u0E33\u0E23\u0E30\u0E40\u0E07\u0E34\u0E19",
      "cta": "\u0E1A\u0E15\u0E2D\u0E19\u0E19\u0E35\u0E49",
      ...
      "header2_p2_test": "\u0E04\u0E25\u0E34\u0E01\u0E42\u0E04\u0E49\u0E14\u0E14\u0E49\u0E32\u0E19\u0E25\u0E48\u0E32\u0E07\u0E40\u0E1E\u0E37\u0E48\u0E2D\u0E04\u0E31\u0E14\u0E25\u0E2D\u0E01\u0E41\u0E25\u0E30\u0E43\u0E0A\u0E49\u0E40\u0E1B\u0E47\u0E19\u0E2A\u0E48\u0E27\u0E19\u0E25\u0E14"
    },
    "turkey": {
      "header1": "S\u0131n\u0131rl\u0131 s\u00FCreyle ge\u00E7erlidir",
      "header2": "Bug\u00FCn video sipari\u015Finizde %20 indirim",
      "header1_p2": "",
      "header2_p2": "%20 indiriminiz \u00F6deme s\u0131ras\u0131nda uygulanacakt\u0131r.",
      "cta": "\u015Eimdi kullan",
      "your_cart": "Sepetiniz",
      "subtotal": "Ara Toplam",
      "discount": "\u0130ndirim",
      ...
      "header2_p2_test": "A\u015Fa\u011F\u0131daki koda t\u0131klayarak kopyalay\u0131n ve \u00F6deme s\u0131ras\u0131nda uygulay\u0131n"
    },
    "dutch": {
      "header1": "Tijdelijke aanbieding",
      "header2": "Vandaag 20% korting op de bestelling van je beelden",
      "header1_p2": "",
      "header2_p2": "Je 20% korting wordt toegepast bij het afrekenen.",
      "cta": "Ontvang nu",
      ...
      "header2_p2_test": "Klik op onderstaande code om te kopi\u00EBren en toe te passen bij het afrekenen"
    },
    "french": {
      "header1": "Offre \u00E0 dur\u00E9e limit\u00E9e",
      "header2": "20 % de r\u00E9duction sur votre commande de s\u00E9quences vid\u00E9o aujourd'hui",
      "header1_p2": "",
      "header2_p2": "Votre remise de 20 % sera appliqu\u00E9e lors du paiement.",
      ...
      "header2_p2_test": "Cliquez sur le code ci-dessous pour le copier et l'appliquer au paiement"
    },
    "german": {
      "header1": "Nur f\u00FCr kurze Zeit",
      "header2": "Sichern Sie sich heute 20 % Rabatt auf Videomaterial",
      "header1_p2": "",
      "header2_p2": "Der 20 % Rabatt wird beim Checkout angewendet.",
      "cta": "Jetzt einl\u00F6sen",
      ...
      "header2_p2_test": "Kopieren Sie den Code unten und geben Sie ihn beim Bezahlvorgang ein."
    },
    "italian": {
      "header1": "Solo per un periodo limitato",
      "header2": "20% di sconto sui tuoi filmati",
      "header1_p2": "",
      "header2_p2": "Lo sconto del 20% verr\u00E0 applicato al checkout.",
      "cta": "Riscatta ora",
      "your_cart": "Carrello",
      "subtotal": "Subtotale",
      "discount": "Sconto",
      ...
      "header2_p2_test": "Clicca sul codice per copiarlo e utilizzarlo in fase di pagamento"
    },
    "korean": {
      "header1": "\uAE30\uAC04 \uD55C\uC815 \uD61C\uD0DD",
      "header2": "\uB2E8 \uC624\uB298\uB9CC \uC601\uC0C1 \uAD6C\uB9E4\uD558\uACE0 20% \uD560\uC778 \uBC1B\uAE30",
      "header1_p2": "",
      "header2_p2": "20% \uD560\uC778\uC740 \uACB0\uC81C \uC2DC \uC801\uC6A9\uB429\uB2C8\uB2E4.",
      "cta": "\uC9C0\uAE08 \uC0AC\uC6A9\uD558\uC138\uC694",
      "your_cart": "\uC7A5\uBC14\uAD6C\uB2C8",
      "subtotal": "\uD569\uACC4",
      "discount": "\uD560\uC778",
      ...
      "header2_p2_test": "\uC544\uB798 \uD560\uC778 \uCF54\uB4DC\uB97C \uBCF5\uC0AC\uD558\uC5EC \uACB0\uC81C \uC2DC \uC801\uC6A9\uD574 \uC8FC\uC138\uC694."
    },
    "portuguese": {
      "header1": "Oferta por tempo limitado",
      "header2": "S\u00F3 hoje: 20% de desconto na sua compra de imagens",
      "header1_p2": "",
      "header2_p2": "Seu desconto de 20% ser\u00E1 aplicado no checkout.",
      "cta": "Redimir agora",
      ...
      "header2_p2_test": "Clique no c\u00F3digo abaixo para copiar e usar na finaliza\u00E7\u00E3o da compra"
    },
    "espanol": {
      "header1": "Solo por tiempo limitado",
      "header2": "20% de descuento hoy en tu pedido de v\u00EDdeos",
      "header1_p2": "",
      "header2_p2": "Tu descuento del 20% se aplicar\u00E1 al finalizar la compra.",
      "cta": "Canjear ahora",
      ...
      "header2_p2_test": "Haz clic el c\u00F3digo de abajo para copiarlo y \u00FAsalo al pagar"
    },
    "japanese": {
      "header1": "\u671F\u9593\u9650\u5B9A",
      "header2": "\u672C\u65E5\u3001\u52D5\u753B\u7D20\u6750\u306E\u3054\u6CE8\u6587\u304C20\uFF05\u30AA\u30D5",
      "header1_p2": "",
      "header2_p2": "20\uFF05\u5272\u5F15\u306F\u30C1\u30A7\u30C3\u30AF\u30A2\u30A6\u30C8\u6642\u306B\u9069\u7528\u3055\u308C\u307E\u3059\u3002",
      "cta": "\u4ECA\u3059\u3050\u5229\u7528",
      "your_cart": "\u30AB\u30FC\u30C8",
      "subtotal": "\u5C0F\u8A08",
      "discount": "\u30C7\u30A3\u30B9\u30AB\u30A6\u30F3\u30C8",
      ...
      "header2_p2_test": "\u4E0B\u306E\u30AF\u30FC\u30DD\u30F3\u30B3\u30FC\u30C9\u3092\u30B3\u30D4\u30FC\u3057\u3066\u3001\u30C1\u30A7\u30C3\u30AF\u30A2\u30A6\u30C8\u6642\u306B\u3054\u5229\u7528\u304F\u3060\u3055\u3044"
    },
    "hindi": {
      "header1": "\u0938\u093F\u0930\u094D\u092B\u093C \u0915\u0941\u091B \u0938\u092E\u092F \u0915\u0947 \u0932\u093F\u090F",
      "header2": "\u0906\u091C \u0939\u0940 \u0905\u092A\u0928\u0947 \u092B\u0941\u091F\u0947\u091C \u0911\u0930\u094D\u0921\u0930 \u092A\u0930 20% \u0915\u0940 \u091B\u0942\u091F",
      "header1_p2": "",
      "header2_p2": "\u0906\u092A\u0915\u0940 20% \u091B\u0942\u091F \u091A\u0947\u0915\u0906\u0909\u091F \u0915\u0947 \u0938\u092E\u092F \u0932\u093E\u0917\u0942 \u0939\u094B\u0917\u0940\u0964",
      "cta": "\u0905\u092D\u0940 \u0930\u093F\u0921\u0940\u092E \u0915\u0930\u0947\u0902",
      ...
      "header2_p2_test": "\u091A\u0947\u0915\u0906\u0909\u091F \u0915\u0947 \u0938\u092E\u092F \u0915\u0949\u092A\u0940 \u0915\u0930\u0928\u0947 \u0914\u0930 \u0905\u092A\u094D\u0932\u093E\u0908 \u0915\u0930\u0928\u0947 \u0915\u0947 \u0932\u093F\u090F \u0928\u0940\u091A\u0947 \u0926\u093F\u090F \u0917\u090F \u0915\u094B\u0921 \u092A\u0930 \u0915\u094D\u0932\u093F\u0915 \u0915\u0930\u0947\u0902"
    },
    "tamil": {
      "header1": "\u0B95\u0BC1\u0BB1\u0BBF\u0BAA\u0BCD\u0BAA\u0BBF\u0B9F\u0BCD\u0B9F \u0B95\u0BBE\u0BB2\u0BA4\u0BCD\u0BA4\u0BBF\u0BB1\u0BCD\u0B95\u0BC1 \u0BAE\u0B9F\u0BCD\u0B9F\u0BC1\u0BAE\u0BCD",
      "header2": "\u0B87\u0BA9\u0BCD\u0BB1\u0BC7 \u0B89\u0B99\u0BCD\u0B95\u0BB3\u0BCD \u0B95\u0BBE\u0BA3\u0BCA\u0BB3\u0BBF\u0B95\u0BCD \u0B95\u0BBE\u0B9F\u0BCD\u0B9A\u0BBF\u0B95\u0BCD\u0B95\u0BC1 20% \u0BA4\u0BB3\u0BCD\u0BB3\u0BC1\u0BAA\u0B9F\u0BBF",
      "header1_p2": "",
      "header2_p2": "\u0B89\u0B99\u0BCD\u0B95\u0BB3\u0BCD 20% \u0BA4\u0BB3\u0BCD\u0BB3\u0BC1\u0BAA\u0B9F\u0BBF \u0B9A\u0BC6\u0BB2\u0BC1\u0BA4\u0BCD\u0BA4\u0BC1\u0BAE\u0BCD \u0BAA\u0BCB\u0BA4\u0BC1 \u0BAA\u0BAF\u0BA9\u0BCD\u0BAA\u0B9F\u0BC1\u0BA4\u0BCD\u0BA4\u0BAA\u0BCD\u0BAA\u0B9F\u0BC1\u0BAE\u0BCD.",
      ...
      "header2_p2_test": "\u0BAA\u0BA3\u0BAE\u0BCD \u0B9A\u0BC6\u0BB2\u0BC1\u0BA4\u0BCD\u0BA4\u0BC1\u0BAE\u0BCD \u0BAA\u0BCB\u0BA4\u0BC1 \u0BA8\u0B95\u0BB2\u0BC6\u0B9F\u0BC1\u0BA4\u0BCD\u0BA4\u0BC1\u0BAA\u0BCD \u0BAA\u0BAF\u0BA9\u0BCD\u0BAA\u0B9F\u0BC1\u0BA4\u0BCD\u0BA4, \u0B95\u0BC0\u0BB4\u0BC7 \u0B89\u0BB3\u0BCD\u0BB3 \u0B95\u0BC1\u0BB1\u0BBF\u0BAF\u0BC0\u0B9F\u0BCD\u0B9F\u0BC8\u0B95\u0BCD \u0B95\u0BBF\u0BB3\u0BBF\u0B95\u0BCD \u0B9A\u0BC6\u0BAF\u0BCD\u0BAF\u0BB5\u0BC1\u0BAE\u0BCD"
    },
    "telugu": {
      "header1": "\u0C2A\u0C30\u0C3F\u0C2E\u0C3F\u0C24 \u0C15\u0C3E\u0C32\u0C02 \u0C2E\u0C3E\u0C24\u0C4D\u0C30\u0C2E\u0C47",
      "header2": "\u0C08 \u0C30\u0C4B\u0C1C\u0C41 \u0C2E\u0C40 \u0C2B\u0C41\u0C1F\u0C47\u0C1C\u0C4D \u0C06\u0C30\u0C4D\u0C21\u0C30\u0C4D\u200C\u0C2A\u0C48 20% \u0C24\u0C17\u0C4D\u0C17\u0C3F\u0C02\u0C2A\u0C41",
      "header1_p2": "",
      "header2_p2": "\u0C2E\u0C40 20% \u0C24\u0C17\u0C4D\u0C17\u0C3F\u0C02\u0C2A\u0C41 \u0C1A\u0C46\u0C32\u0C4D\u0C32\u0C3F\u0C02\u0C2A\u0C41 \u0C38\u0C2E\u0C2F\u0C02\u0C32\u0C4B \u0C35\u0C30\u0C4D\u0C24\u0C3F\u0C02\u0C2A\u0C1C\u0C47\u0C2F\u0C2C\u0C21\u0C41\u0C24\u0C41\u0C02\u0C26\u0C3F.",
      ...
      "header2_p2_test": "\u0C15\u0C4B\u0C21\u0C4D\u200C\u0C28\u0C41 \u0C15\u0C3E\u0C2A\u0C40 \u0C1A\u0C47\u0C38\u0C41\u0C15\u0C4B\u0C35\u0C21\u0C3E\u0C28\u0C3F\u0C15\u0C3F \u0C15\u0C4D\u0C30\u0C3F\u0C02\u0C26 \u0C09\u0C28\u0C4D\u0C28 \u0C15\u0C4B\u0C21\u0C4D\u200C\u0C2A\u0C48 \u0C15\u0C4D\u0C32\u0C3F\u0C15\u0C4D \u0C1A\u0C47\u0C38\u0C3F, \u0C1A\u0C46\u0C15\u0C4C\u0C1F\u0C4D \u0C38\u0C2E\u0C2F\u0C02\u0C32\u0C4B \u0C09\u0C2A\u0C2F\u0C4B\u0C17\u0C3F\u0C02\u0C1A\u0C02\u0C21\u0C3F"
    },
    "marathi": {
      "header1": "\u092E\u0930\u094D\u092F\u093E\u0926\u093F\u0924 \u0915\u093E\u0932\u093E\u0935\u0927\u0940\u0938\u093E\u0920\u0940\u091A",
      "header2": "\u0906\u091C \u0924\u0941\u092E\u091A\u094D\u092F\u093E \u092B\u0941\u091F\u0947\u091C \u0911\u0930\u094D\u0921\u0930\u0935\u0930 20% \u0938\u0942\u091F",
      "header1_p2": "",
      "header2_p2": "\u0924\u0941\u092E\u091A\u0940 20% \u0938\u0942\u091F \u091A\u0947\u0915\u0906\u0909\u091F\u091A\u094D\u092F\u093E \u0935\u0947\u0933\u0940 \u0932\u093E\u0917\u0942 \u0939\u094B\u0908\u0932.",
      "cta": "\u0906\u0924\u093E \u0930\u093F\u0921\u0940\u092E \u0915\u0930\u093E",
      ...
      "header2_p2_test": "\u0916\u093E\u0932\u0940\u0932 \u0915\u094B\u0921\u0935\u0930 \u0915\u094D\u0932\u093F\u0915 \u0915\u0930\u0942\u0928 \u0924\u094B \u0915\u0949\u092A\u0940 \u0915\u0930\u093E \u0906\u0923\u093F \u091A\u0947\u0915\u0906\u0909\u091F \u0915\u0930\u0924\u093E\u0928\u093E \u0932\u093E\u0917\u0942 \u0915\u0930\u093E"
    }
  },
